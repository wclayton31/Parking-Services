<%@ Page Language="C#" AutoEventWireup="true" CodeFile="/Student/ViewInfo.aspx.cs" Inherits="ViewInfo" MasterPageFile="~/Master.master" %>
<asp:Content ID="Content10" ContentPlaceHolderID="MyContent" runat="server">
    ...
    <br /><hr />
    <img src="/images/StudentInfo.png" alt="" />
<table class="tg">
  <tr>
  ...
  <tr>
    ...
    <td class="auto-style12"><asp:CompareValidator runat="server" Operator="DataTypeCheck" Type="Integer" 
                    ControlToValidate="LicenseTextBox" ErrorMessage="License must be a whole number." ForeColor="Red" /></td>
  </tr>
   <tr>
